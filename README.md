...
| **Audio Keyword Hunt**                            | Develop vocabulary and listening skills                   | 1. Play five key sentences from the story<br>2. Students discuss keywords in pairs using an online dictionary<br>3. Submit keywords via Google Forms<br>4. Generate live word cloud | 🎯**App#1-Online Dictionary** - Image, pronunciation, example sentences <br> 🎯**App#2-Keyword Cloud**[Keyword Cloud](https://huggingface.co/spaces/verastudio/keywordcloud)<br>- [Google Form](https://forms.gle/uyBgxdJQgPVdK2DZ8) | 5 mins  |
