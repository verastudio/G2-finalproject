...
| **2. Audio Keyword Hunt** | 10 m | To engage students in listening and comprehension by identifying keywords for scaffolded learning | ✅ **App #1: Online Dictionary & Word Cloud** <br> **App#2: Word Cloud** <br>🔹 **Steps:** <br> **1.** T plays five key sentences from the story for the whole class. <br> **2.**  Students pair up and use an online dictionary to discuss and understand the keywords. <br> **3.**  Pairs select the most important keyword for each sentence and submit their choices using Google Forms. <br>  **4.** T generates a live word cloud. <br> |🔹**Purpose:** Listening practice, understanding main ideas, and keyword learning. <br> 🔹**Worksheet Example:** <br> Google Form questions with multiple-choice options for keywords. <br> Live word cloud generation from collected responses. |
| **3. Word Cloud & Sentence Creation** | 10 m | Create meaningful sentences using identified keywords. | <br> ✅**App #2:**Word Cloud** <br>  🔹**Steps:** <br> 1. Display the word cloud and explain each keyword using a pre-prepared Padlet. <br> 3. Students create sentences using keywords and post them on Padlet. <br> 3. Students explore the online dictionary again if needed. <br> **Purpose:** Vocabulary learning and sentence creation. <br> **Worksheet Example:** <br> Padlet entries with dictionary definitions, images, pronunciations, and example sentences. <br> Student-generated sentences posted on Padlet. |
