...
| **4. Story Listening II - Relay Writing with Keywords** | Reinforce comprehension and writing skills using keywords        | **1.** Review images from the story reconstruction activity<br>**2.** Each student selects a keyword from the Keyword Cloud<br>**3.** Students take turns writing a description of each image in sequence on Padlet **4.** Submit summaries on [Padlet](https://padlet.com/mirankim316/introduction-to-coding-and-language-app-design-tesol-spring--njwe895ytgl83hhu) | 🎯**App#2**-[Keyword Cloud](https://huggingface.co/spaces/verastudio/keywordcloud)<br> | 7 mins  |
