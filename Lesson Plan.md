...
| **2. Listening and Keyword Extraction** | 10 m | Extract and identify keywords from listening passages. | ✅ **App #1: Audio Keyword Hunt** <br>🔹 **Steps:** <br> **1.** Play five key sentences from the story. <br> **2.** Students use Google Forms to select the keyword from each sentence. <br> **3.** Responses are downloaded to generate a live word cloud with WordClouds.com. <br> 🔹**Purpose:** Listening practice, understanding main ideas, and keyword learning. <br> 🔹**Worksheet Example:** <br> Google Form questions with multiple-choice options for keywords. <br> Live word cloud generation from collected responses. |
