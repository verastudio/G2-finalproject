...
| **3. Word Cloud Exploration and Sentence Creation** | 10 m | Create meaningful sentences using identified keywords. | <br> ✅**App #2:** Padlet for collaborative learning. <br>  🔹**Steps:** <br> 1. Display the word cloud and explain each keyword using a pre-prepared Padlet. <br> 2. Students explore the Padlet entries (definitions, images, pronunciation, example sentences). <br> 3. Students create sentences using keywords and post them on Padlet. <br> **Purpose:** Vocabulary learning and sentence creation. <br> **Worksheet Example:** <br> Padlet entries with dictionary definitions, images, pronunciations, and example sentences. <br> Student-generated sentences posted on Padlet. |
