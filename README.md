...
| **2. Audio Keyword Hunt**                            | Develop vocabulary and listening skills                   | **1.** Play five key sentences from the story.<br>**2.** Discuss keywords in groups using an online dictionary. <br>**3.** Submit keywords via [Google Form](https://forms.gle/uyBgxdJQgPVdK2DZ8).<br>**4.** Generate live keyword cloud.| 🎯**App#1**-[Online Dictionary](https://huggingface.co/spaces/verastudio/Online_Dictionary)
