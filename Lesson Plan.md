...
| **Audio Keyword Hunt**                            | Develop vocabulary and listening skills                   | 1. Play five key sentences from the story<br>2. Students discuss keywords in pairs using an online dictionary<br>3. Submit keywords via Google Forms<br>4. Generate live word cloud | - Online Dictionary: ![QR Code](https://example.com/online_dictionary_qr.png) <br> - Keyword Cloud: ![QR Code](https://example.com/keyword_cloud_qr.png)<br> - [Google Forms](https://forms.google.com) | 20 mins  |
| **Story Listening I - Reconstruction**            | Enhance comprehension through visual aids and sequence arrangement | 1. Play the full audio of the story<br>2. Students arrange pictures in sequence in groups<br>3. Review the correct sequence with the class                  | - Story Reconstruction App: ![QR Code](https://example.com/story_reconstruction_qr.png)<br> - Story Order Images: ![QR Code](https://example.com/story_order_images_qr.png) | 20 mins  |
| **Story Listening II - Replay Writing with Keywords** | Reinforce comprehension and writing skills using keywords        | 1. Review images from the reconstruction activity<br>2. Each student selects a keyword from the Keyword Cloud<br>3. Write summaries<br>4. Submit summaries on Padlet | - Keyword Cloud: ![QR Code](https://example.com/keyword_cloud_qr.png)<br> - [Padlet](https://padlet.com)                                                             | 20 mins  |
| **Writing a Letter to Grandpa (with more scaffolding)** | Practice formal writing and comprehension through a structured activity | 1. Write thank-you emails using Letter Maker1<br>2. Listen to Grandpa's voice email<br>3. Answer questions using a multiple-choice quiz app                | - Letter Maker1: ![QR Code](https://example.com/letter_maker1_qr.png)<br> - Grandpa's Reply Video: ![QR Code](https://example.com/grandpa_reply_qr.png)<br> - Multiple Choice Quiz App: ![QR Code](https://example.com/mcq_qr.png) | 20 mins  |
| **Writing a Letter to the Grandson (with less scaffolding)** | Develop independent writing skills through a less structured activity | 1. Write thank-you emails using Letter Maker2<br>2. Submit emails on Padlet<br>3. Leave feedback on peers' emails                                           | - Letter Maker2: ![QR Code](https://example.com/letter_maker2_qr.png)<br> - [Padlet](https://padlet.com)                                                             | 20 mins  |
