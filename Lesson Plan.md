...
| **6. Homework Assignment** | - |To practice formal letter writing skills |🔹 **Steps:** <br> **1.** Distribute the letter template to students. <br>**2.** Explain the purpose: to encourage and support Mr. Elias. <br>**3.** Students write the body of the letter. <br>**4.** Provide optional intro and conclusion phrases for students to choose from. <br>
**5.** Use the "Letter Maker" tool to compile the letter. <br> **Worksheet Example:** <br> Letter template with sections (Dear..., Intro, Body, Conclusion). <br> Students write a full letter and submit it for preview in the next class. |✅**App #5: Letter Maker.** | 
