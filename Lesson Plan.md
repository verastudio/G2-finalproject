...
| **2. Listening and Keyword Extraction** | 10 m | To engage students in listening and comprehension by identifying keywords for scaffolded learning | ✅ **App #1: Audio Keyword Hunt** <br>🔹 **Steps:** <br> **1.** Play five key sentences from the story. <br> **2.**  Students pair up and use an online dictionary to discuss and understand the keywords. <br> **3.**  Pairs select the most important keyword for each sentence and submit their choices using Google Forms. <br> | **4.** Download responses and generate a live word cloud using WordClouds.com. <br> |🔹**Purpose:** Listening practice, understanding main ideas, and keyword learning. <br> 🔹**Worksheet Example:** <br> Google Form questions with multiple-choice options for keywords. <br> Live word cloud generation from collected responses. |
| **3. Word Cloud Exploration and Sentence Creation** | 10 m | Create meaningful sentences using identified keywords. | **Implementation:** <br> - ✅**App #2:** Padlet for collaborative learning. <br> - 🔹**Steps:** <br> 1. Display the word cloud and explain each keyword using a pre-prepared Padlet. <br> 2. Students explore the Padlet entries (definitions, images, pronunciation, example sentences). <br> 3. Students create sentences using keywords and post them on Padlet. <br> **Purpose:** Vocabulary learning and sentence creation. <br> **Worksheet Example:** <br> Padlet entries with dictionary definitions, images, pronunciations, and example sentences. <br> Student-generated sentences posted on Padlet. |
| **4. Story Prediction and Writing** | 10 m | Predict story content and create a continuation using keywords. | **Implementation:** <br> - ✅**App #3:** Google Doc or Slides for collaborative writing. <br> - **Steps:** <br> 1. Using keywords, students predict the story and fill in blanks or continue the story. <br> 2. Teacher reviews and discusses predictions. <br> **Purpose:** Creative writing and comprehension. <br> **Worksheet Example:** <br> Google Doc with prompts for story prediction and continuation. |
| **5. Story Reconstruction and Listening Practice** | 10 m | Reconstruct the story sequence based on audio prompts. | **Implementation:** <br> - ✅**App #4:** Audio files and images for sequencing. <br> - **Steps:** <br> 1. Students listen to mixed-up sentences from the story. <br> 2. Students use corresponding images to sequence the sentences correctly. <br> **Purpose:** Enhance listening skills and story comprehension. <br> **Worksheet Example:** <br> Audio clips of mixed-up sentences. <br> Images corresponding to each sentence for sequencing. |
| **6. Writing a Note to the Grandfather** | 5 m | Write thank-you notes using learned phrases. | **Implementation:** <br> - ✅**App #5:** Google Forms for note submission and real-time display. <br> - **Steps:** <br> 1. Students write thank-you notes using phrases learned in class. <br> 2. Notes are submitted via Google Forms and displayed as post-it notes on the screen. <br> **Purpose:** Practice writing polite expressions and gratitude. <br> **Worksheet Example:** <br> Google Form prompts for thank-you notes. <br> Real-time display of notes. |
| **7. Homework Assignment** | - | Extend writing practice with a formal letter. | **Activity:** Writing a letter to Mr. Elias using a provided template. <br> **Worksheet Example:** <br> Letter template with sections (Dear..., Intro, Body, Conclusion). <br> Students write a full letter and submit it for review in the next class. |
