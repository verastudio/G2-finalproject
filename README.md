...
| **Audio Keyword Hunt**                            | Develop vocabulary and listening skills                   | **1.** Play five key sentences from the story.<br>**2.** Students discuss keywords in groups using an [online dictionary.](https://huggingface.co/spaces/verastudio/keywordcloud) <br>**3.** Submit keywords via [Google Form](https://forms.gle/uyBgxdJQgPVdK2DZ8).<br>**4.** Generate live word cloud.| 🎯**App#1-Online Dictionary** <br> **Google Form** <br>🎯**App#2-**[Keyword Cloud](https://huggingface.co/spaces/verastudio/keywordcloud)| 5 mins  |
