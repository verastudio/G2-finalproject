...
| **4. Story Prediction and Writing** | 10 m | Predict story content and create a continuation using keywords. | **Implementation:** <br> - **App:** Google Doc or Slides for collaborative writing. <br> - **Steps:** <br> 1. Using keywords, students predict the story and fill in blanks or continue the story. <br> 2. Teacher reviews and discusses predictions. <br> **Purpose:** Creative writing and comprehension. <br> **Worksheet Example:** <br> Google Doc with prompts for story prediction and continuation. |
...
| **6. Writing a Note to the Grandfather** | 5 m | Write thank-you notes using learned phrases. | **Implementation:** <br> - **App:** Google Forms for note submission and real-time display. <br> - **Steps:** <br> 1. Students write thank-you notes using phrases learned in class. <br> 2. Notes are submitted via Google Forms and displayed as post-it notes on the screen. <br> **Purpose:** Practice writing polite expressions and gratitude. <br> **Worksheet Example:** <br> Google Form prompts for thank-you notes. <br> Real-time display of notes. |
