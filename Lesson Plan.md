...
| **6. Homework Assignment** | - |  **Activity:** Writing a letter to Mr. Elias using a provided template. <br> **Worksheet Example:** <br> Letter template with sections (Dear..., Intro, Body, Conclusion). <br> Students write a full letter and submit it for review in the next class. | ✅**App #5:** Extend writing practice with a formal letter. | 
