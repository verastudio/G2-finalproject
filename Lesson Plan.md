...
| **3. Word Cloud & Sentence Creation** | 10 m | Create meaningful sentences using identified keywords. | ✅**App #2:**Word Cloud** <br>  🔹 **Steps:** <br> **1.** Display the word cloud and explain each keyword using a pre-prepared Padlet. <br> 3. Students create sentences using keywords and post them on Padlet. <br> 3. Students explore the online dictionary again if needed. <br> **Purpose:** Vocabulary learning and sentence creation. <br> **Worksheet Example:** <br> Padlet entries with dictionary definitions, images, pronunciations, and example sentences. <br> Student-generated sentences posted on Padlet. |
